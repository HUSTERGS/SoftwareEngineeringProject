...
public class Sudo extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(0, 0, this.width*9, this.height*9, paint);
        ...
        for (int i = 0; i < 9; i++) {
            ...
            // 横轴
            canvas.drawLine(0, i * height + 3, width*9, i * height + 3, paint);
            // 纵轴
            canvas.drawLine(i * width + 3, 0, i * width + 3, height*9, paint);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (event.getAction() == MotionEvent.ACTION_DOWN && event.getX()<width*9 && event.getY()<height*9) {
